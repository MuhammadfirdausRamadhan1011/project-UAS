...
def api_artikel_list(request):
    key_token = "7e4e7f55948d7a2cabcc388cb1d871b7869af4e86f629413f7b8f52f2b1935c1"
...
def api_artikel_detail(request, id_artikel):
    try:
        ...
        return Response({'message:data artikel tidak ditemuka'}, status=status.HTTP_404_NOT_FOUND)
